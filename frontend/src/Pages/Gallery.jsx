                    ...
                    {filteredImages.map((image, index) => {
                        ...
                        return (
                            ...
                            >
                                ...
                                <div
                                    className={`absolute -top-3 left-1/2 transform -translate-x-1/2 w-16 h-8 ${polaroidStyle.tapeColor} opacity-80 ${polaroidStyle.tapeRotation} shadow-sm`}
                                >
                                    <div className="w-full h-full border border-yellow-300 opacity-50"></div>
                                </div>
                                <div
                                    className={`absolute -top-2 right-8 w-12 h-6 ${polaroidStyle.tapeColor} opacity-70 rotate-45 shadow-sm`}
                                >
                                    <div className="w-full h-full border border-yellow-300 opacity-50"></div>
                                </div>
                                <div
                                    className="absolute bottom-20 right-4 bg-amber-600 text-white rounded-full p-2 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                                >
                                ...
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center space-x-4">
                                        ...
                                        <div className="flex items-center space-x-2">
                                            ...
                                            <span className="text-sm">{new Date(lightboxImage.uploadDate).toLocaleDateString()}</span>
                                        </div>
                                    </div>
